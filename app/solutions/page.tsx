...
const mainSolutions = [
  ...
  },
  {
    ...
    benefits: [
      ...
      "Historique pour suivre la progression de chaque prospect",
      // "Scoring automatique des leads selon leur engagement",
      "Communication intégrée : emails, notifications",
  ...
  },
  {
    ...
    benefits: [
      "Profils agents avec portefeuille de biens",
      "Suivi des performances individuelles et collectives",
      "Attribution  des visites et des biens aux agents",
  ...
  },
  {
    ...
    benefits: [
      "Modèles de contrats standard (vente, location)",
